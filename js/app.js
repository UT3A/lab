...
烘培。是個想聊天但不敢先開口的I人。`,
  ...
  },
  {
    ...
    tags:['C++','Java','Android'],
    photo:'image/114/114EP8024_黃聖瑋.jpg', 
    thumb:'YT',
  ...
  {
    name:'大石鍊', role:'ms2', roleLabel:'碩二生',
    tags:['資料庫','RPA'],
    //photo:'image/114/114EP8002_呂芯穎.jpg', 
    thumb:'大石鍊',
    bio:`大家好,我是大石。畢業於大同大學資訊經營系。大學專題是協助會計事務所流程自動化。希望在研究所期間學習機器學習及資訊在金融中的應用，處理各類問題。我的興趣是踢足球﹑看日劇。`,
    works:['MAIL：t113ab8000@ntut.org.tw']
  },
  {
    name:'陽彩柔', role:'ms2', roleLabel:'碩二生',
    tags:['資料處理','C / C++'],
    //photo:'image/114/114EP8002_呂芯穎.jpg', 
    thumb:'陽彩柔',
    bio:`嗨～我是陽彩柔，畢業於中原大學資工系，在研究所期間想了解資訊技術與財金領域如何碰撞產生出更多創新的發展，並且想學習透過數據分析、機器學習等技術協助與解決不同領域的問題。我的興趣是運動、聽音樂、看劇。`,
    works:['MAIL：t113ab8000@ntut.org.tw']
  }
